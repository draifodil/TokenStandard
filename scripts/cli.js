...
const contractABI = require("../artifacts/contracts/Tokenstandard.sol/Tokenstandard.json").abi;

program
    .name("tokenstandard-cli")
    .description("CLI tool for Tokenstandard smart contract")
    .version("1.0.0");
